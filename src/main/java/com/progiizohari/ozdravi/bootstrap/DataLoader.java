...
//              child
        ...
        List<Examination> examinations = new ArrayList<>(Arrays.asList(
                new Examination("Fluktuirajući emocionalni sindrom (FES): Pacijent izvješćuje o naglim promjenama emocionalnog stanja bez očitog uzroka.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(0)),
                new Examination("Sanjarski poremećaj stvarnosti (SPS): Osoba doživljava intenzivne snove koji utječu na njezino dnevno funkcioniranje.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "N", medicalRecords.get(1)),
                new Examination("Vampirski sanjski poremećaj (VSP): Pacijent izvješćuje o učestalim snovima u kojima se doživljava kao vampir.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(2)),
                new Examination("Kreativna nesanica (KN): Osoba doživljava nesanicu zbog pretjerane kreativnosti i maštovitih misli tijekom noći.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(3)),
                new Examination("Telepatski sindrom s ljubimcima (TSL): Pacijent tvrdi da može komunicirati telepatski sa svojim kućnim ljubimcem.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "N", medicalRecords.get(4)),
                new Examination("Alergija na virtualnu stvarnost (AVS): Osoba doživljava alergijske reakcije kad koristi virtualnu stvarnost.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "N", medicalRecords.get(5)),
                new Examination("Noćno plivanje u zraku (NPZ): Pacijent tvrdi da sanja o plivanju u zraku tijekom noći.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(6)),
                new Examination("Osmijehomanija (OM): Osoba osjeća neodoljivu potrebu za stalnim izražavanjem osmijeha.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(7)),
                new Examination("Misteriozni sindrom simpatičnosti (MSS): Pacijent izvješćuje o doživljavanju snažnog suosjećanja prema nepoznatim ljudima.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(8)),
                new Examination("Retroaktivna pamćenja (RP): Osoba povremeno doživljava trenutke iz prošlosti kao da se događaju sada.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(9)),
                new Examination("Nesanica zbog crtića (NC): Pacijent doživljava nesanicu zbog pretjerane gledanosti crtića.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(10)),
                new Examination("Stvaranje snova u snu (SSS): Osoba tvrdi da stvara kompleksne snove dok spava.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(11)),
                new Examination("Ovisnost o crtićima (OC): Pacijent se osjeća ovisnim o gledanju crtića.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(12)),
                new Examination("Ljubavni bolovi (LB): Osoba doživljava emocionalnu bol povezanu s ljubavnim iskustvima.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "D", medicalRecords.get(13)),
                new Examination("Sanjarenje o fantastičnim svjetovima (SFS): Pacijent često sanjari o nevjerojatnim svjetovima i iskustvima.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), "N", medicalRecords.get(14))
        ));
