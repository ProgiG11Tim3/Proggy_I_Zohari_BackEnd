...
//              child
        ...
        List<MedicalReport> medicalReports = new ArrayList<>(Arrays.asList(
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,1,12,56)), "Pacijent dolazi radi prehlade, poslan na kućni odmor.", medicalRecords.get(0)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,2,13,43)), "Pacijent dolazi radi pogoršanja stanja. Poslan na hitnu.", medicalRecords.get(0)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,2,12,32)), "Pacijent dolazi radi brzog kucanja srca. Poslan specijalistu.", medicalRecords.get(1)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,3,14,42)), "Pacijent dolazi radi cijepljenja protiv COVID-19. Cijepljenje uspješno.", medicalRecords.get(1)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,3,15,12)), "Pacijent dolazi radi glasova u glavi. Upućen specijalistu.", medicalRecords.get(2)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,4,16,45)), "Pacijent dolazi radi upisa nalaza u karton.", medicalRecords.get(2)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,4,12,34)), "Pacijent dolazi radi bolova u ruci. Upućen doma.", medicalRecords.get(3)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,5,17,12)), "Pacijent dolazi radi pogoršanja stanja. Poslan na hitnu.", medicalRecords.get(3)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,5,10,54)), "Pacijent dolazi radi povraćanja. Prepisana terapija.", medicalRecords.get(4)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,6,16,34)), "Pacijent dolazi radi ponovnog povraćanja. Prepisana druga terapija.", medicalRecords.get(4)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,6,9,2)), "Pacijent doživljava niz neobjašnjivih simptoma poput blagog vrtoglavice, svjetlucanja pred očima i povremenih bolova u trbuhu.", medicalRecords.get(5)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,7,12,52)), "Pacijent tvrdi da je doživio iznenadni porast kreativnosti koji ga čini nemirnim te želi konzultirati stručnjaka.", medicalRecords.get(5)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,7,11,22)), "Osoba tvrdi da osjeća bolove u ljubavi i želi konzultirati ljekara za emocionalnu pomoć.", medicalRecords.get(6)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,8,16,12)), "Pacijent tvrdi da često sanjari o fantastičnim svjetovima i želi provjeriti ima li to veze s njegovim mentalnim zdravljem.", medicalRecords.get(6)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,8,12,12)), "Osoba tvrdi da primjećuje sjaj u vlastitim očima i osjeća se prezdravo, želi saznati je li sve u redu.", medicalRecords.get(7)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,9,17,22)), "Pacijent tvrdi da može razgovarati s vlastitim organima i želi medicinsko objašnjenje za to iskustvo.", medicalRecords.get(7)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,9,10,22)), "Osoba tvrdi da povremeno gubi osjet mirisa boja, ali samo kad gleda umjetničke slike.", medicalRecords.get(8)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,10,11,32)), "Pacijent tvrdi da ne može prestati smijati se nakon gledanja određenog smiješnog videa te želi konzultirati stručnjaka o tome.", medicalRecords.get(8)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,10,12,12)), "Osoba tvrdi da može čitati misli bliskih ljudi i želi razgovarati s liječnikom o tome.", medicalRecords.get(9)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,11,19,32)), "Pacijent tvrdi da postaje nespretan dok sanja i često pada iz kreveta te želi konzultirati liječnika o ovom \"problemu\".", medicalRecords.get(9)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,11,9,22)), "Pacijent tvrdi da povremeno doživljava trenutke iz prošlosti kao da se događaju sada, te želi konzultirati stručnjaka o ovom fenomenu.", medicalRecords.get(10)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,12,12,12)), "Osoba tvrdi da se osjeća ovisnom o gledanju crtića i zabrinuta je zbog toga.", medicalRecords.get(10)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,12,10,12)), "Pacijent tvrdi da sanja da je vampir i želi razgovarati s liječnikom o svojim noćnim avanturama.", medicalRecords.get(11)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,13,19,52)), "Osoba tvrdi da vidi nevidljivu svjetlost koja ju okružuje i želi utvrditi ima li to veze s njezinim zdravljem.", medicalRecords.get(11)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,13,9,42)), "Pacijent tvrdi da stvara kompleksne pjesme dok spava i želi saznati je li to normalno ili zabrinjavajuće.", medicalRecords.get(12)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,14,12,2)), "Osoba tvrdi da može komunicirati telepatski sa svojim kućnim ljubimcem i želi stručno mišljenje o toj vezi.", medicalRecords.get(12)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,14,8,42)), "Pacijent tvrdi da osjeća alergijske reakcije kad koristi virtualnu stvarnost te želi konzultirati stručnjaka o tome.", medicalRecords.get(13)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,15,15,12)), "Osoba tvrdi da osjeća potrebu za stalnim izražavanjem osmijeha i želi konzultirati liječnika o svojoj poticajnoj ovisnosti.", medicalRecords.get(13)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,15,12,52)), "Pacijent tvrdi da sanja kako pliva u zraku noću te želi saznati ima li to veze s njegovim zdravljem.", medicalRecords.get(14)),
                new MedicalReport(Timestamp.valueOf(LocalDateTime.of(2024, 1,16,19,42)), "Osoba tvrdi da se neprestano smije dok obavlja kupovinu i želi konzultirati stručnjaka o svom čudnom ponašanju.", medicalRecords.get(14))
        ));
        List<Examination> examinations = new ArrayList<>(Arrays.asList(
                new Examination("Fluktuirajući emocionalni sindrom (FES): Pacijent izvješćuje o naglim promjenama emocionalnog stanja bez očitog uzroka.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(0)),
                new Examination("Sanjarski poremećaj stvarnosti (SPS): Osoba doživljava intenzivne snove koji utječu na njezino dnevno funkcioniranje.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), false, medicalRecords.get(1)),
                new Examination("Vampirski sanjski poremećaj (VSP): Pacijent izvješćuje o učestalim snovima u kojima se doživljava kao vampir.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(2)),
                new Examination("Kreativna nesanica (KN): Osoba doživljava nesanicu zbog pretjerane kreativnosti i maštovitih misli tijekom noći.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), false, medicalRecords.get(3)),
                new Examination("Telepatski sindrom s ljubimcima (TSL): Pacijent tvrdi da može komunicirati telepatski sa svojim kućnim ljubimcem.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(4)),
                new Examination("Alergija na virtualnu stvarnost (AVS): Osoba doživljava alergijske reakcije kad koristi virtualnu stvarnost.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), false, medicalRecords.get(5)),
                new Examination("Noćno plivanje u zraku (NPZ): Pacijent tvrdi da sanja o plivanju u zraku tijekom noći.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(6)),
                new Examination("Osmijehomanija (OM): Osoba osjeća neodoljivu potrebu za stalnim izražavanjem osmijeha.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(7)),
                new Examination("Misteriozni sindrom simpatičnosti (MSS): Pacijent izvješćuje o doživljavanju snažnog suosjećanja prema nepoznatim ljudima.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(8)),
                new Examination("Retroaktivna pamćenja (RP): Osoba povremeno doživljava trenutke iz prošlosti kao da se događaju sada.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(9)),
                new Examination("Nesanica zbog crtića (NC): Pacijent doživljava nesanicu zbog pretjerane gledanosti crtića.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(10)),
                new Examination("Stvaranje snova u snu (SSS): Osoba tvrdi da stvara kompleksne snove dok spava.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(11)),
                new Examination("Ovisnost o crtićima (OC): Pacijent se osjeća ovisnim o gledanju crtića.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(12)),
                new Examination("Ljubavni bolovi (LB): Osoba doživljava emocionalnu bol povezanu s ljubavnim iskustvima.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(13)),
                new Examination("Sanjarenje o fantastičnim svjetovima (SFS): Pacijent često sanjari o nevjerojatnim svjetovima i iskustvima.", Timestamp.valueOf(LocalDateTime.of(2024, 1,12,16,32)), true, medicalRecords.get(14))
        ));
        ...
        List<HospitalLocation> hospitalLocations = new ArrayList<>(Arrays.asList(
                ...
                new HospitalLocation("DJEČJA BOLNICA SREBRNJAK", "GRAD ZAGREB", "SREBRNJAK 100", 45.825340922006134, 15.993832492058567),
                new HospitalLocation("NAFTALAN, SPECIJALNA BOLNICA ZA MEDICINSKU REHABILITACIJU", "IVANIĆ-GRAD", "OMLADINSKA 23 A", 45.70629876936312, 16.386341042328453),
                new HospitalLocation("SPECIJALNA BOLNICA ZA MEDICINSKU REHABILITACIJU KRAPINSKE TOPLICE", "KRAPINSKE TOPLICE", "GAJEVA 2", 46.09317158063337, 15.837884299999999),
                new HospitalLocation("PSIHIJATRIJSKA BOLNICA LOPAČA", "DRAŽICE", "LOPAČA 11", 45.37797380000001, 14.441011999999999),
                new HospitalLocation("LJEČILIŠTE VELI LOŠINJ", "VELI LOŠINJ", "PODJAVORI 27", 44.51753445946934, 14.50178618029128)
                ));
        List<SpecialistExamination> specialistExaminations = new ArrayList<>(Arrays.asList(
                new SpecialistExamination("Oftalmolog (pregled vida): Stručnjak će ispitali vaš vid kroz različite testove poput provjere oštrine vida, provjere boje, i pregleda očne pozadine kako bi dijagnosticirao i liječio probleme s vidom.", medicalRecords.get(0), new ArrayList<>(Arrays.asList(hospitalLocations.get(0), hospitalLocations.get(1), hospitalLocations.get(2))) ),
                new SpecialistExamination("Dermatolog (pregled kože): Liječnik će pregledati vašu kožu kako bi identificirao promjene, madeže ili kožne bolesti. Moguće je i izvršiti biopsiju kože radi daljnje analize.", medicalRecords.get(1), new ArrayList<>(Arrays.asList(hospitalLocations.get(0), hospitalLocations.get(1))) ),
                new SpecialistExamination("Kardiolog (kardiološki pregled): Specijalist će pregledati vaše srce pomoću elektrokardiograma (EKG), auskultacije i drugih testova kako bi procijenio zdravlje srca i identificirao moguće probleme.", medicalRecords.get(2), new ArrayList<>(Arrays.asList(hospitalLocations.get(1), hospitalLocations.get(3))) ),
                new SpecialistExamination("Ginekolog (ginekološki pregled): Specijalist će pregledati reproduktivne organe žene, uključujući pregled vrata maternice i dojki. Može provesti i PAPA test ili mamografiju.", medicalRecords.get(3), new ArrayList<>(Arrays.asList(hospitalLocations.get(0))) ),
                new SpecialistExamination("Ortoped (ortopedski pregled): Pregleda zglobove, kosti i mišiće kako bi dijagnosticirao i liječio problema s mišićno-koštanim sustavom.", medicalRecords.get(4), new ArrayList<>(Arrays.asList(hospitalLocations.get(4), hospitalLocations.get(5), hospitalLocations.get(6))) ),
                new SpecialistExamination("Neurolog (neurološki pregled): Pregledava živčani sustav, provodeći testove poput refleksa, provjere koordinacije i procjene senzacija kako bi dijagnosticirao neurološke poremećaje.", medicalRecords.get(5), new ArrayList<>(Arrays.asList(hospitalLocations.get(7), hospitalLocations.get(8), hospitalLocations.get(9))) ),
                new SpecialistExamination("Gastroenterolog (gastroenterološki pregled): Pregledava probavni sustav, uključujući želudac, crijeva i jetru, pomoću različitih testova poput endoskopije ili kolonoskopije.", medicalRecords.get(6), new ArrayList<>(Arrays.asList(hospitalLocations.get(10), hospitalLocations.get(11), hospitalLocations.get(12))) ),
                new SpecialistExamination("Psihijatar (psihijatrijski pregled): Razgovara s pacijentom o emocionalnom i mentalnom zdravlju te postavlja dijagnozu i pruža terapiju.", medicalRecords.get(7), new ArrayList<>(Arrays.asList(hospitalLocations.get(12), hospitalLocations.get(13), hospitalLocations.get(14))) ),
                new SpecialistExamination("Endokrinolog (endokrinološki pregled): Pregledava hormonalni sustav tijela, uključujući štitnjaču, nadbubrežne žlijezde i gušteraču.", medicalRecords.get(8), new ArrayList<>(Arrays.asList(hospitalLocations.get(15), hospitalLocations.get(16), hospitalLocations.get(17))) ),
                new SpecialistExamination("Pulmolog (pulmološki pregled): Pregledava dišni sustav i pluća kako bi dijagnosticirao i liječio probleme s disanjem i respiratornim sustavom.", medicalRecords.get(9), new ArrayList<>(Arrays.asList(hospitalLocations.get(17))) ),
                new SpecialistExamination("Urolog (urološki pregled): Pregledava mokraćni sustav, uključujući bubrege, mjehur i genitalije, kako bi dijagnosticirao i liječio probleme urogenitalnog područja.", medicalRecords.get(10), new ArrayList<>(Arrays.asList(hospitalLocations.get(12))) ),
                new SpecialistExamination("Reumatolog (reumatološki pregled): Pregledava zglobove, mišiće i kosti kako bi dijagnosticirao i liječio reumatske bolesti.", medicalRecords.get(11), new ArrayList<>(Arrays.asList(hospitalLocations.get(16))) ),
                new SpecialistExamination("Alergolog (alergološki pregled): Pregledava pacijenta kako bi identificirao alergijske reakcije i odredio uzročnike alergija.", medicalRecords.get(12), new ArrayList<>(Arrays.asList(hospitalLocations.get(6))) ),
                new SpecialistExamination("ENT specijalist (otorinolaringološki pregled): Pregledava uši, nos i grlo kako bi dijagnosticirao i liječio probleme u tim područjima.", medicalRecords.get(13), new ArrayList<>(Arrays.asList(hospitalLocations.get(1))) ),
                new SpecialistExamination("Nutricionist (nutricionistički pregled): Pregledava prehrambene navike, zdravstvene uvjete i ciljeve pacijenta kako bi pružio prilagođene prehrambene preporuke.", medicalRecords.get(14), new ArrayList<>(Arrays.asList(hospitalLocations.get(2))) )
                ));
        List<SickLeaveRecommendation> sickLeaveRecommendations = new ArrayList<>(Arrays.asList(
                new SickLeaveRecommendation(parents.get(0), "Respiratorna infekcija: Preporučujem da ostanete kod kuće kako biste spriječili širenje respiratornih infekcija. Odmaranje i ograničavanje kontakta s drugima pomoći će vašem tijelu da se oporavi bez izlaganja drugima.", parents.get(0).getEmployerEmail()),
                new SickLeaveRecommendation(parents.get(1), "Postoperativna njega: Kako biste osigurali uspješan oporavak nakon operacije, preporučujem da ostanete kod kuće u mirnom okruženju. Odmor je ključan za brži oporavak.", parents.get(1).getEmployerEmail()),
                new SickLeaveRecommendation(parents.get(2), "Kontakt s potencijalnim alergenima: S obzirom na vašu dijagnozu alergije, preporučujem izbjegavanje kontakta s poznatim alergenima. Ostanak kod kuće pomoći će u smanjenju izloženosti i ublažavanju simptoma.", parents.get(2).getEmployerEmail()),
